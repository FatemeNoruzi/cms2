...
import {EducationMeetingDeleteComponent} from './dialogComponent/educationMeetingDelete/education.meeting.delete.component';
import {EducationMeetingSearchComponent} from './dialogComponent/educationMeetingSearch/education.meeting.search.component';
...
export class EducationMeetingComponent {
  ...
  openDialogDeleteComponent() {
    const dialogRef = this.dialog.open(EducationMeetingDeleteComponent, {
      height: '350px'
    });
  ...
  openSearchDialog(): void {
    const dialogRef = this.dialog.open(EducationMeetingSearchComponent, {
      width: '250px',
      data: { startDate: this.startDate, endDate: this.endDate, title: this.title, code: this.code  }
    });
