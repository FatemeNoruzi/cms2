...
import {EducationGatheringDeleteComponent} from './dialogComponent/educationGatheringDelete/education.gathering.delete.component';
import {EducationGatheringSearchComponent} from './dialogComponent/educationGatheringSearch/education.gathering.search.component';
 ...
 */
@Component ({
selector: 'app-education-gathering' ,
templateUrl: './education.gathering.component.html' ,
styleUrls: ['./education.gathering.component.css']
})
export class EducationGatheringComponent {

  displayedColumns = ['select', 'id', 'name', 'weight', 'symbol'];
  ...
  openDialogDeleteComponent() {
    const dialogRef = this.dialog.open(EducationGatheringDeleteComponent, {
      height: '350px'
    });
  ...
  openSearchDialog(): void {
    const dialogRef = this.dialog.open(EducationGatheringSearchComponent, {
      width: '250px',
      data: { startDate: this.startDate, endDate: this.endDate, name: this.name, address: this.address  }
    });
