...
import {UsersRevokeRequestSearchComponent} from './dialogComponent/usersRevokeRequestSearch/users.revoke.request.search.component';
import {UsersRevokeRequestDeleteComponent} from './dialogComponent/usersRevokeRequestDelete/users.revoke.request.delete.component';
...
@Component ({
selector: 'app-users' ,
templateUrl: './users.revoke.request.component.html' ,
styleUrls: ['./users.revoke.request.component.css']
})
export class UsersRevokeRequestComponent {
...
openSearchDialog(): void {
    const dialogRef = this.dialog.open(UsersRevokeRequestSearchComponent, {
    width: '350px',
