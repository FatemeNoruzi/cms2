...
import {UsersNocodeSearchComponent} from './dialogComponent/usersNocodeSearch/users.nocode.search.component';
...
@Component ({
selector: 'app-users' ,
templateUrl: './users.nocode.component.html' ,
styleUrls: ['./users.nocode.component.css']
})
  
export class UsersNocodeComponent {
...
openSearchDialog(): void {
    const dialogRef = this.dialog.open(UsersNocodeSearchComponent, {
    width: '350px',
