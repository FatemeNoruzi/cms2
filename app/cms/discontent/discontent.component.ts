 ...
 */
@Component ({
selector: 'app-discontent' ,
templateUrl: './discontent.component.html' ,
styleUrls: ['./discontent.component.css']
})
export class DiscontentComponent {
...
openDialogDeleteComponent() {
    const dialogRef = this.dialog.open(DiscontentDeleteComponent, {
    height: '350px'
    });
...
openSearchDialog(): void {
    const dialogRef = this.dialog.open(DiscontentSearchComponent, {
    width: '350px',
    data: { startDate: this.startDate, endDate: this.endDate, email: this.email, code: this.code  }
    });
